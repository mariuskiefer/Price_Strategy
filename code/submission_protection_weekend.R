# Inputs
mL <- c(8, 10, 12, 18, 20, 25, 23, 20, 15, 9)  # Mean demand for low-fare (single bookings)
mH <- c(2, 3, 4, 6, 7, 8, 6, 4, 2, 1)         # Mean demand for high-fare (group bookings)
pL <- c(7, 7, 7, 10, 10, 10, 10, 10, 7, 7)               # Price for low-fare
pH <- c(20, 20, 20, 26, 26, 26, 26, 26, 20, 20)         # Price for high-fare
